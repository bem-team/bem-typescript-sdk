...
export class Outputs extends APIResource {
  ...
  ): PagePromise<OutputListResponsesOutputsPage, OutputListResponse> {
    return this._client.getAPIList('/v3/outputs', OutputsPage<OutputListResponse>, { query, ...options });
  }
}

export type OutputListResponsesOutputsPage = OutputsPage<OutputListResponse>;
...
export interface OutputRetrieveResponse {
   ...
   */
  output:
    | OutputRetrieveResponse.TransformEvent
    | OutputRetrieveResponse.ExtractEvent
    | OutputRetrieveResponse.RouteEvent
    | OutputRetrieveResponse.ClassifyEvent
    | OutputRetrieveResponse.SplitCollectionEvent
    | OutputRetrieveResponse.SplitItemEvent
    | ErrorsAPI.ErrorEvent
    | OutputRetrieveResponse.JoinEvent
    | OutputRetrieveResponse.EnrichEvent
    | OutputRetrieveResponse.CollectionProcessingEvent
    | OutputRetrieveResponse.SendEvent;
}

export namespace OutputRetrieveResponse {
...
export type OutputListResponse =
  | OutputListResponse.TransformEvent
  | OutputListResponse.ExtractEvent
  | OutputListResponse.RouteEvent
  | OutputListResponse.ClassifyEvent
  | OutputListResponse.SplitCollectionEvent
  | OutputListResponse.SplitItemEvent
  | ErrorsAPI.ErrorEvent
  | OutputListResponse.JoinEvent
  | OutputListResponse.EnrichEvent
  | OutputListResponse.CollectionProcessingEvent
  | OutputListResponse.SendEvent;
...
export interface OutputListParams extends OutputsPageParams {
   ...
   */
  functionVersionNums?: Array<number>;
