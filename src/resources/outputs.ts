...
export namespace Event {
  ...
  export interface ParseEvent {
     ...
     * Corrected feedback provided for fine-tuning purposes.
     */
    correctedContent?: ParseEvent.Output | unknown | Array<unknown> | string | number | boolean | null;
     ...
     */
    inputs?: Array<ParseEvent.Input> | null;
  ...
  export interface AnalyzeEvent {
    ...
    metadata?: AnalyzeEvent.Metadata;
   ...
   * `transformedContent`.
   */
  export interface PayloadShapingEvent {
    /**
     * Unique ID generated by bem to identify the event.
     */
    eventID: string;
    ...
    metadata?: PayloadShapingEvent.Metadata;
  ...
  export namespace PayloadShapingEvent {
    export interface Metadata {
      durationFunctionToEventSeconds?: number;
    }
  }
