...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    response:
      '{ inbound: { firstSeenAt: string; mentionCount: number; relationType: string; sourceEntity: { id: string; canonical: string; depth: number; type: string; }; }[]; outbound: { firstSeenAt: string; mentionCount: number; relationType: string; targetEntity: { id: string; canonical: string; depth: number; type: string; }; }[]; nextCursor?: string; }',
    markdown:
