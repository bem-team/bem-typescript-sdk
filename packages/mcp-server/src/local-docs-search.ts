...
const EMBEDDED_METHODS: MethodEntry[] = [
  {
    ...
    params: [
      "{ functionName: string; type: 'extract'; displayName?: string; outputSchema?: object; outputSchemaName?: string; tabularChunkingEnabled?: boolean; tags?: string[]; } | { functionName: string; type: 'classify'; classifications?: { name: string; description?: string; functionID?: string; functionName?: string; isErrorFallback?: boolean; origin?: { email?: { patterns?: string[]; }; }; regex?: { patterns?: string[]; }; }[]; description?: string; displayName?: string; tags?: string[]; } | { functionName: string; type: 'send'; destinationType?: 'webhook' | 's3' | 'google_drive'; displayName?: string; googleDriveFolderId?: string; s3Bucket?: string; s3Prefix?: string; tags?: string[]; webhookSigningEnabled?: boolean; webhookUrl?: string; } | { functionName: string; type: 'split'; displayName?: string; printPageSplitConfig?: { nextFunctionID?: string; nextFunctionName?: string; }; semanticPageSplitConfig?: { itemClasses?: { name: string; description?: string; nextFunctionID?: string; nextFunctionName?: string; }[]; }; splitType?: 'print_page' | 'semantic_page'; tags?: string[]; } | { functionName: string; type: 'join'; description?: string; displayName?: string; joinType?: 'standard'; outputSchema?: object; outputSchemaName?: string; tags?: string[]; } | { functionName: string; type: 'payload_shaping'; displayName?: string; shapingSchema?: string; tags?: string[]; } | { functionName: string; type: 'enrich'; config?: { steps: object[]; }; displayName?: string; tags?: string[]; };",
    ],
    response: '{ function: object | object | object | object | object | object | object | object | object; }',
    perLanguage: {
      cli: {
  ...
  },
  {
    ...
    response: '{ function: object | object | object | object | object | object | object | object | object; }',
    markdown:
      "## retrieve\n\n`client.functions.retrieve(functionName: string): { function: object | object | object | object | object | object | object | object | object; }`\n\n**get** `/v3/functions/{functionName}`\n\nGet a Function\n\n### Parameters\n\n- `functionName: string`\n\n### Returns\n\n- `{ function: { emailAddress: string; functionID: string; functionName: string; outputSchema: object; outputSchemaName: string; tabularChunkingEnabled: boolean; type: 'transform'; versionNum: number; audit?: object; displayName?: string; tags?: string[]; usedInWorkflows?: object[]; } | { functionID: string; functionName: string; outputSchema: object; outputSchemaName: string; tabularChunkingEnabled: boolean; type: 'extract'; versionNum: number; audit?: object; displayName?: string; tags?: string[]; usedInWorkflows?: object[]; } | { enableBoundingBoxes: boolean; functionID: string; functionName: string; outputSchema: object; outputSchemaName: string; preCount: boolean; type: 'analyze'; versionNum: number; audit?: object; displayName?: string; tags?: string[]; usedInWorkflows?: object[]; } | { classifications: { name: string; description?: string; functionID?: string; functionName?: string; isErrorFallback?: boolean; origin?: object; regex?: object; }[]; description: string; emailAddress: string; functionID: string; functionName: string; type: 'classify'; versionNum: number; audit?: object; displayName?: string; tags?: string[]; usedInWorkflows?: object[]; } | { destinationType: 'webhook' | 's3' | 'google_drive'; functionID: string; functionName: string; type: 'send'; versionNum: number; audit?: object; displayName?: string; googleDriveFolderId?: string; s3Bucket?: string; s3Prefix?: string; tags?: string[]; usedInWorkflows?: object[]; webhookSigningEnabled?: boolean; webhookUrl?: string; } | { functionID: string; functionName: string; splitType: 'print_page' | 'semantic_page'; type: 'split'; versionNum: number; audit?: object; displayName?: string; printPageSplitConfig?: { nextFunctionID?: string; }; semanticPageSplitConfig?: { itemClasses?: split_function_semantic_page_item_class[]; }; tags?: string[]; usedInWorkflows?: object[]; } | { description: string; functionID: string; functionName: string; joinType: 'standard'; outputSchema: object; outputSchemaName: string; type: 'join'; versionNum: number; audit?: object; displayName?: string; tags?: string[]; usedInWorkflows?: object[]; } | { functionID: string; functionName: string; shapingSchema: string; type: 'payload_shaping'; versionNum: number; audit?: object; displayName?: string; tags?: string[]; usedInWorkflows?: object[]; } | { config: object; functionID: string; functionName: string; type: 'enrich'; versionNum: number; audit?: object; displayName?: string; tags?: string[]; usedInWorkflows?: object[]; }; }`\n  Single-function response wrapper used by V3 function endpoints.\nV3 wraps individual function responses in a `{\"function\": ...}` envelope\nfor consistency with other V3 resource endpoints.\n\n  - `function: { emailAddress: string; functionID: string; functionName: string; outputSchema: object; outputSchemaName: string; tabularChunkingEnabled: boolean; type: 'transform'; versionNum: number; audit?: { functionCreatedBy?: object; functionLastUpdatedBy?: object; versionCreatedBy?: object; }; displayName?: string; tags?: string[]; usedInWorkflows?: { currentVersionNum: number; usedInWorkflowVersionNums: number[]; workflowID: string; workflowName: string; }[]; } | { functionID: string; functionName: string; outputSchema: object; outputSchemaName: string; tabularChunkingEnabled: boolean; type: 'extract'; versionNum: number; audit?: { functionCreatedBy?: object; functionLastUpdatedBy?: object; versionCreatedBy?: object; }; displayName?: string; tags?: string[]; usedInWorkflows?: { currentVersionNum: number; usedInWorkflowVersionNums: number[]; workflowID: string; workflowName: string; }[]; } | { enableBoundingBoxes: boolean; functionID: string; functionName: string; outputSchema: object; outputSchemaName: string; preCount: boolean; type: 'analyze'; versionNum: number; audit?: { functionCreatedBy?: object; functionLastUpdatedBy?: object; versionCreatedBy?: object; }; displayName?: string; tags?: string[]; usedInWorkflows?: { currentVersionNum: number; usedInWorkflowVersionNums: number[]; workflowID: string; workflowName: string; }[]; } | { classifications: { name: string; description?: string; functionID?: string; functionName?: string; isErrorFallback?: boolean; origin?: { email?: { patterns?: string[]; }; }; regex?: { patterns?: string[]; }; }[]; description: string; emailAddress: string; functionID: string; functionName: string; type: 'classify'; versionNum: number; audit?: { functionCreatedBy?: object; functionLastUpdatedBy?: object; versionCreatedBy?: object; }; displayName?: string; tags?: string[]; usedInWorkflows?: { currentVersionNum: number; usedInWorkflowVersionNums: number[]; workflowID: string; workflowName: string; }[]; } | { destinationType: 'webhook' | 's3' | 'google_drive'; functionID: string; functionName: string; type: 'send'; versionNum: number; audit?: { functionCreatedBy?: object; functionLastUpdatedBy?: object; versionCreatedBy?: object; }; displayName?: string; googleDriveFolderId?: string; s3Bucket?: string; s3Prefix?: string; tags?: string[]; usedInWorkflows?: { currentVersionNum: number; usedInWorkflowVersionNums: number[]; workflowID: string; workflowName: string; }[]; webhookSigningEnabled?: boolean; webhookUrl?: string; } | { functionID: string; functionName: string; splitType: 'print_page' | 'semantic_page'; type: 'split'; versionNum: number; audit?: { functionCreatedBy?: object; functionLastUpdatedBy?: object; versionCreatedBy?: object; }; displayName?: string; printPageSplitConfig?: { nextFunctionID?: string; }; semanticPageSplitConfig?: { itemClasses?: { name: string; description?: string; nextFunctionID?: string; nextFunctionName?: string; }[]; }; tags?: string[]; usedInWorkflows?: { currentVersionNum: number; usedInWorkflowVersionNums: number[]; workflowID: string; workflowName: string; }[]; } | { description: string; functionID: string; functionName: string; joinType: 'standard'; outputSchema: object; outputSchemaName: string; type: 'join'; versionNum: number; audit?: { functionCreatedBy?: object; functionLastUpdatedBy?: object; versionCreatedBy?: object; }; displayName?: string; tags?: string[]; usedInWorkflows?: { currentVersionNum: number; usedInWorkflowVersionNums: number[]; workflowID: string; workflowName: string; }[]; } | { functionID: string; functionName: string; shapingSchema: string; type: 'payload_shaping'; versionNum: number; audit?: { functionCreatedBy?: object; functionLastUpdatedBy?: object; versionCreatedBy?: object; }; displayName?: string; tags?: string[]; usedInWorkflows?: { currentVersionNum: number; usedInWorkflowVersionNums: number[]; workflowID: string; workflowName: string; }[]; } | { config: { steps: object[]; }; functionID: string; functionName: string; type: 'enrich'; versionNum: number; audit?: { functionCreatedBy?: object; functionLastUpdatedBy?: object; versionCreatedBy?: object; }; displayName?: string; tags?: string[]; usedInWorkflows?: { currentVersionNum: number; usedInWorkflowVersionNums: number[]; workflowID: string; workflowName: string; }[]; }`\n\n### Example\n\n```typescript\nimport Bem from 'bem-ai-sdk';\n\nconst client = new Bem();\n\nconst functionResponse = await client.functions.retrieve('functionName');\n\nconsole.log(functionResponse);\n```",
    perLanguage: {
      cli: {
  ...
  },
  {
    ...
    params: [
      'functionName: string;',
      "body: { type: 'extract'; displayName?: string; functionName?: string; outputSchema?: object; outputSchemaName?: string; tabularChunkingEnabled?: boolean; tags?: string[]; } | { type: 'classify'; classifications?: { name: string; description?: string; functionID?: string; functionName?: string; isErrorFallback?: boolean; origin?: { email?: { patterns?: string[]; }; }; regex?: { patterns?: string[]; }; }[]; description?: string; displayName?: string; functionName?: string; tags?: string[]; } | { type: 'send'; destinationType?: 'webhook' | 's3' | 'google_drive'; displayName?: string; functionName?: string; googleDriveFolderId?: string; s3Bucket?: string; s3Prefix?: string; tags?: string[]; webhookSigningEnabled?: boolean; webhookUrl?: string; } | { type: 'split'; displayName?: string; functionName?: string; printPageSplitConfig?: { nextFunctionID?: string; nextFunctionName?: string; }; semanticPageSplitConfig?: { itemClasses?: { name: string; description?: string; nextFunctionID?: string; nextFunctionName?: string; }[]; }; splitType?: 'print_page' | 'semantic_page'; tags?: string[]; } | { type: 'join'; description?: string; displayName?: string; functionName?: string; joinType?: 'standard'; outputSchema?: object; outputSchemaName?: string; tags?: string[]; } | { type: 'payload_shaping'; displayName?: string; functionName?: string; shapingSchema?: string; tags?: string[]; } | { type: 'enrich'; config?: { steps: object[]; }; };",
    ],
    response: '{ function: object | object | object | object | object | object | object | object | object; }',
    perLanguage: {
      cli: {
  ...
  },
  {
    ...
    params: ['functionName: string;'],
    response:
      '{ totalCount?: number; versions?: object | object | object | object | object | object | object | object | object[]; }',
    markdown:
      "## list\n\n`client.functions.versions.list(functionName: string): { totalCount?: number; versions?: object | object | object | object | object | object | object | object | object[]; }`\n\n**get** `/v3/functions/{functionName}/versions`\n\nList Function Versions\n\n### Parameters\n\n- `functionName: string`\n\n### Returns\n\n- `{ totalCount?: number; versions?: { emailAddress: string; functionID: string; functionName: string; outputSchema: object; outputSchemaName: string; tabularChunkingEnabled: boolean; type: 'transform'; versionNum: number; audit?: object; createdAt?: string; displayName?: string; tags?: string[]; usedInWorkflows?: object[]; } | { functionID: string; functionName: string; outputSchema: object; outputSchemaName: string; tabularChunkingEnabled: boolean; type: 'extract'; versionNum: number; audit?: object; createdAt?: string; displayName?: string; tags?: string[]; usedInWorkflows?: object[]; } | { enableBoundingBoxes: boolean; functionID: string; functionName: string; outputSchema: object; outputSchemaName: string; preCount: boolean; type: 'analyze'; versionNum: number; audit?: object; createdAt?: string; displayName?: string; tags?: string[]; usedInWorkflows?: object[]; } | { classifications: { name: string; description?: string; functionID?: string; functionName?: string; isErrorFallback?: boolean; origin?: object; regex?: object; }[]; description: string; emailAddress: string; functionID: string; functionName: string; type: 'classify'; versionNum: number; audit?: object; createdAt?: string; displayName?: string; tags?: string[]; usedInWorkflows?: object[]; } | { destinationType: 'webhook' | 's3' | 'google_drive'; functionID: string; functionName: string; type: 'send'; versionNum: number; audit?: object; createdAt?: string; displayName?: string; googleDriveFolderId?: string; s3Bucket?: string; s3Prefix?: string; tags?: string[]; usedInWorkflows?: object[]; webhookSigningEnabled?: boolean; webhookUrl?: string; } | { functionID: string; functionName: string; splitType: 'print_page' | 'semantic_page'; type: 'split'; versionNum: number; audit?: object; createdAt?: string; displayName?: string; printPageSplitConfig?: { nextFunctionID?: string; }; semanticPageSplitConfig?: { itemClasses?: split_function_semantic_page_item_class[]; }; tags?: string[]; usedInWorkflows?: object[]; } | { description: string; functionID: string; functionName: string; joinType: 'standard'; outputSchema: object; outputSchemaName: string; type: 'join'; versionNum: number; audit?: object; createdAt?: string; displayName?: string; tags?: string[]; usedInWorkflows?: object[]; } | { config: object; functionID: string; functionName: string; type: 'enrich'; versionNum: number; audit?: object; createdAt?: string; displayName?: string; tags?: string[]; usedInWorkflows?: object[]; } | { functionID: string; functionName: string; shapingSchema: string; type: 'payload_shaping'; versionNum: number; audit?: object; createdAt?: string; displayName?: string; tags?: string[]; usedInWorkflows?: object[]; }[]; }`\n\n  - `totalCount?: number`\n  - `versions?: { emailAddress: string; functionID: string; functionName: string; outputSchema: object; outputSchemaName: string; tabularChunkingEnabled: boolean; type: 'transform'; versionNum: number; audit?: { functionCreatedBy?: object; functionLastUpdatedBy?: object; versionCreatedBy?: object; }; createdAt?: string; displayName?: string; tags?: string[]; usedInWorkflows?: { currentVersionNum: number; usedInWorkflowVersionNums: number[]; workflowID: string; workflowName: string; }[]; } | { functionID: string; functionName: string; outputSchema: object; outputSchemaName: string; tabularChunkingEnabled: boolean; type: 'extract'; versionNum: number; audit?: { functionCreatedBy?: object; functionLastUpdatedBy?: object; versionCreatedBy?: object; }; createdAt?: string; displayName?: string; tags?: string[]; usedInWorkflows?: { currentVersionNum: number; usedInWorkflowVersionNums: number[]; workflowID: string; workflowName: string; }[]; } | { enableBoundingBoxes: boolean; functionID: string; functionName: string; outputSchema: object; outputSchemaName: string; preCount: boolean; type: 'analyze'; versionNum: number; audit?: { functionCreatedBy?: object; functionLastUpdatedBy?: object; versionCreatedBy?: object; }; createdAt?: string; displayName?: string; tags?: string[]; usedInWorkflows?: { currentVersionNum: number; usedInWorkflowVersionNums: number[]; workflowID: string; workflowName: string; }[]; } | { classifications: { name: string; description?: string; functionID?: string; functionName?: string; isErrorFallback?: boolean; origin?: { email?: { patterns?: string[]; }; }; regex?: { patterns?: string[]; }; }[]; description: string; emailAddress: string; functionID: string; functionName: string; type: 'classify'; versionNum: number; audit?: { functionCreatedBy?: object; functionLastUpdatedBy?: object; versionCreatedBy?: object; }; createdAt?: string; displayName?: string; tags?: string[]; usedInWorkflows?: { currentVersionNum: number; usedInWorkflowVersionNums: number[]; workflowID: string; workflowName: string; }[]; } | { destinationType: 'webhook' | 's3' | 'google_drive'; functionID: string; functionName: string; type: 'send'; versionNum: number; audit?: { functionCreatedBy?: object; functionLastUpdatedBy?: object; versionCreatedBy?: object; }; createdAt?: string; displayName?: string; googleDriveFolderId?: string; s3Bucket?: string; s3Prefix?: string; tags?: string[]; usedInWorkflows?: { currentVersionNum: number; usedInWorkflowVersionNums: number[]; workflowID: string; workflowName: string; }[]; webhookSigningEnabled?: boolean; webhookUrl?: string; } | { functionID: string; functionName: string; splitType: 'print_page' | 'semantic_page'; type: 'split'; versionNum: number; audit?: { functionCreatedBy?: object; functionLastUpdatedBy?: object; versionCreatedBy?: object; }; createdAt?: string; displayName?: string; printPageSplitConfig?: { nextFunctionID?: string; }; semanticPageSplitConfig?: { itemClasses?: { name: string; description?: string; nextFunctionID?: string; nextFunctionName?: string; }[]; }; tags?: string[]; usedInWorkflows?: { currentVersionNum: number; usedInWorkflowVersionNums: number[]; workflowID: string; workflowName: string; }[]; } | { description: string; functionID: string; functionName: string; joinType: 'standard'; outputSchema: object; outputSchemaName: string; type: 'join'; versionNum: number; audit?: { functionCreatedBy?: object; functionLastUpdatedBy?: object; versionCreatedBy?: object; }; createdAt?: string; displayName?: string; tags?: string[]; usedInWorkflows?: { currentVersionNum: number; usedInWorkflowVersionNums: number[]; workflowID: string; workflowName: string; }[]; } | { config: { steps: object[]; }; functionID: string; functionName: string; type: 'enrich'; versionNum: number; audit?: { functionCreatedBy?: object; functionLastUpdatedBy?: object; versionCreatedBy?: object; }; createdAt?: string; displayName?: string; tags?: string[]; usedInWorkflows?: { currentVersionNum: number; usedInWorkflowVersionNums: number[]; workflowID: string; workflowName: string; }[]; } | { functionID: string; functionName: string; shapingSchema: string; type: 'payload_shaping'; versionNum: number; audit?: { functionCreatedBy?: object; functionLastUpdatedBy?: object; versionCreatedBy?: object; }; createdAt?: string; displayName?: string; tags?: string[]; usedInWorkflows?: { currentVersionNum: number; usedInWorkflowVersionNums: number[]; workflowID: string; workflowName: string; }[]; }[]`\n\n### Example\n\n```typescript\nimport Bem from 'bem-ai-sdk';\n\nconst client = new Bem();\n\nconst versions = await client.functions.versions.list('functionName');\n\nconsole.log(versions);\n```",
    perLanguage: {
      cli: {
      ...
      csharp: {
        ...
        example:
          'VersionListParams parameters = new() { FunctionName = "functionName" };\n\nvar versions = await client.Functions.Versions.List(parameters);\n\nConsole.WriteLine(versions);',
      },
      go: {
        method: 'client.Functions.Versions.List',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/bem-team/bem-go-sdk"\n\t"github.com/bem-team/bem-go-sdk/option"\n)\n\nfunc main() {\n\tclient := bem.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tversions, err := client.Functions.Versions.List(context.TODO(), "functionName")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", versions.TotalCount)\n}\n',
      },
      http: {
        example:
      ...
      python: {
        method: 'functions.versions.list',
        example:
          'import os\nfrom bem import Bem\n\nclient = Bem(\n    api_key=os.environ.get("BEM_API_KEY"),  # This is the default and can be omitted\n)\nversions = client.functions.versions.list(\n    "functionName",\n)\nprint(versions.total_count)',
      },
      typescript: {
        method: 'client.functions.versions.list',
        example:
          "import Bem from 'bem-ai-sdk';\n\nconst client = new Bem({\n  apiKey: process.env['BEM_API_KEY'], // This is the default and can be omitted\n});\n\nconst versions = await client.functions.versions.list('functionName');\n\nconsole.log(versions.totalCount);",
      },
    },
  },
  {
    ...
    response: '{ function: object | object | object | object | object | object | object | object | object; }',
    markdown:
      "## retrieve\n\n`client.functions.versions.retrieve(functionName: string, versionNum: number): { function: object | object | object | object | object | object | object | object | object; }`\n\n**get** `/v3/functions/{functionName}/versions/{versionNum}`\n\nGet a Function Version\n\n### Parameters\n\n- `functionName: string`\n\n- `versionNum: number`\n\n### Returns\n\n- `{ function: { emailAddress: string; functionID: string; functionName: string; outputSchema: object; outputSchemaName: string; tabularChunkingEnabled: boolean; type: 'transform'; versionNum: number; audit?: object; createdAt?: string; displayName?: string; tags?: string[]; usedInWorkflows?: object[]; } | { functionID: string; functionName: string; outputSchema: object; outputSchemaName: string; tabularChunkingEnabled: boolean; type: 'extract'; versionNum: number; audit?: object; createdAt?: string; displayName?: string; tags?: string[]; usedInWorkflows?: object[]; } | { enableBoundingBoxes: boolean; functionID: string; functionName: string; outputSchema: object; outputSchemaName: string; preCount: boolean; type: 'analyze'; versionNum: number; audit?: object; createdAt?: string; displayName?: string; tags?: string[]; usedInWorkflows?: object[]; } | { classifications: { name: string; description?: string; functionID?: string; functionName?: string; isErrorFallback?: boolean; origin?: object; regex?: object; }[]; description: string; emailAddress: string; functionID: string; functionName: string; type: 'classify'; versionNum: number; audit?: object; createdAt?: string; displayName?: string; tags?: string[]; usedInWorkflows?: object[]; } | { destinationType: 'webhook' | 's3' | 'google_drive'; functionID: string; functionName: string; type: 'send'; versionNum: number; audit?: object; createdAt?: string; displayName?: string; googleDriveFolderId?: string; s3Bucket?: string; s3Prefix?: string; tags?: string[]; usedInWorkflows?: object[]; webhookSigningEnabled?: boolean; webhookUrl?: string; } | { functionID: string; functionName: string; splitType: 'print_page' | 'semantic_page'; type: 'split'; versionNum: number; audit?: object; createdAt?: string; displayName?: string; printPageSplitConfig?: { nextFunctionID?: string; }; semanticPageSplitConfig?: { itemClasses?: split_function_semantic_page_item_class[]; }; tags?: string[]; usedInWorkflows?: object[]; } | { description: string; functionID: string; functionName: string; joinType: 'standard'; outputSchema: object; outputSchemaName: string; type: 'join'; versionNum: number; audit?: object; createdAt?: string; displayName?: string; tags?: string[]; usedInWorkflows?: object[]; } | { config: object; functionID: string; functionName: string; type: 'enrich'; versionNum: number; audit?: object; createdAt?: string; displayName?: string; tags?: string[]; usedInWorkflows?: object[]; } | { functionID: string; functionName: string; shapingSchema: string; type: 'payload_shaping'; versionNum: number; audit?: object; createdAt?: string; displayName?: string; tags?: string[]; usedInWorkflows?: object[]; }; }`\n  Single-function-version response wrapper used by V3 endpoints.\n\n  - `function: { emailAddress: string; functionID: string; functionName: string; outputSchema: object; outputSchemaName: string; tabularChunkingEnabled: boolean; type: 'transform'; versionNum: number; audit?: { functionCreatedBy?: object; functionLastUpdatedBy?: object; versionCreatedBy?: object; }; createdAt?: string; displayName?: string; tags?: string[]; usedInWorkflows?: { currentVersionNum: number; usedInWorkflowVersionNums: number[]; workflowID: string; workflowName: string; }[]; } | { functionID: string; functionName: string; outputSchema: object; outputSchemaName: string; tabularChunkingEnabled: boolean; type: 'extract'; versionNum: number; audit?: { functionCreatedBy?: object; functionLastUpdatedBy?: object; versionCreatedBy?: object; }; createdAt?: string; displayName?: string; tags?: string[]; usedInWorkflows?: { currentVersionNum: number; usedInWorkflowVersionNums: number[]; workflowID: string; workflowName: string; }[]; } | { enableBoundingBoxes: boolean; functionID: string; functionName: string; outputSchema: object; outputSchemaName: string; preCount: boolean; type: 'analyze'; versionNum: number; audit?: { functionCreatedBy?: object; functionLastUpdatedBy?: object; versionCreatedBy?: object; }; createdAt?: string; displayName?: string; tags?: string[]; usedInWorkflows?: { currentVersionNum: number; usedInWorkflowVersionNums: number[]; workflowID: string; workflowName: string; }[]; } | { classifications: { name: string; description?: string; functionID?: string; functionName?: string; isErrorFallback?: boolean; origin?: { email?: { patterns?: string[]; }; }; regex?: { patterns?: string[]; }; }[]; description: string; emailAddress: string; functionID: string; functionName: string; type: 'classify'; versionNum: number; audit?: { functionCreatedBy?: object; functionLastUpdatedBy?: object; versionCreatedBy?: object; }; createdAt?: string; displayName?: string; tags?: string[]; usedInWorkflows?: { currentVersionNum: number; usedInWorkflowVersionNums: number[]; workflowID: string; workflowName: string; }[]; } | { destinationType: 'webhook' | 's3' | 'google_drive'; functionID: string; functionName: string; type: 'send'; versionNum: number; audit?: { functionCreatedBy?: object; functionLastUpdatedBy?: object; versionCreatedBy?: object; }; createdAt?: string; displayName?: string; googleDriveFolderId?: string; s3Bucket?: string; s3Prefix?: string; tags?: string[]; usedInWorkflows?: { currentVersionNum: number; usedInWorkflowVersionNums: number[]; workflowID: string; workflowName: string; }[]; webhookSigningEnabled?: boolean; webhookUrl?: string; } | { functionID: string; functionName: string; splitType: 'print_page' | 'semantic_page'; type: 'split'; versionNum: number; audit?: { functionCreatedBy?: object; functionLastUpdatedBy?: object; versionCreatedBy?: object; }; createdAt?: string; displayName?: string; printPageSplitConfig?: { nextFunctionID?: string; }; semanticPageSplitConfig?: { itemClasses?: { name: string; description?: string; nextFunctionID?: string; nextFunctionName?: string; }[]; }; tags?: string[]; usedInWorkflows?: { currentVersionNum: number; usedInWorkflowVersionNums: number[]; workflowID: string; workflowName: string; }[]; } | { description: string; functionID: string; functionName: string; joinType: 'standard'; outputSchema: object; outputSchemaName: string; type: 'join'; versionNum: number; audit?: { functionCreatedBy?: object; functionLastUpdatedBy?: object; versionCreatedBy?: object; }; createdAt?: string; displayName?: string; tags?: string[]; usedInWorkflows?: { currentVersionNum: number; usedInWorkflowVersionNums: number[]; workflowID: string; workflowName: string; }[]; } | { config: { steps: object[]; }; functionID: string; functionName: string; type: 'enrich'; versionNum: number; audit?: { functionCreatedBy?: object; functionLastUpdatedBy?: object; versionCreatedBy?: object; }; createdAt?: string; displayName?: string; tags?: string[]; usedInWorkflows?: { currentVersionNum: number; usedInWorkflowVersionNums: number[]; workflowID: string; workflowName: string; }[]; } | { functionID: string; functionName: string; shapingSchema: string; type: 'payload_shaping'; versionNum: number; audit?: { functionCreatedBy?: object; functionLastUpdatedBy?: object; versionCreatedBy?: object; }; createdAt?: string; displayName?: string; tags?: string[]; usedInWorkflows?: { currentVersionNum: number; usedInWorkflowVersionNums: number[]; workflowID: string; workflowName: string; }[]; }`\n\n### Example\n\n```typescript\nimport Bem from 'bem-ai-sdk';\n\nconst client = new Bem();\n\nconst version = await client.functions.versions.retrieve(0, { functionName: 'functionName' });\n\nconsole.log(version);\n```",
    perLanguage: {
      cli: {
