...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    params: ['eventID: string;'],
    response: '{ output: object | object | object | object | error_event | object | object | object; }',
    markdown:
  ...
  },
  {
    ...
    response:
      '{ id: string; createdAt: string; edges: { destinationNodeName: string; sourceNodeName: string; destinationName?: string; }[]; mainNodeName: string; name: string; nodes: { function: object; name: string; }[]; updatedAt: string; versionNum: number; audit?: { versionCreatedBy?: object; workflowCreatedBy?: object; workflowLastUpdatedBy?: object; }; displayName?: string; emailAddress?: string; tags?: string[]; }',
    markdown:
      "## list\n\n`client.workflows.list(displayName?: string, endingBefore?: string, functionIDs?: string[], functionNames?: string[], limit?: number, sortOrder?: 'asc' | 'desc', startingAfter?: string, tags?: string[], workflowIDs?: string[], workflowNames?: string[]): { id: string; createdAt: string; edges: object[]; mainNodeName: string; name: string; nodes: object[]; updatedAt: string; versionNum: number; audit?: object; displayName?: string; emailAddress?: string; tags?: string[]; }`\n\n**get** `/v3/workflows`\n\nList Workflows\n\n### Parameters\n\n- `displayName?: string`\n\n- `endingBefore?: string`\n\n- `functionIDs?: string[]`\n\n- `functionNames?: string[]`\n\n- `limit?: number`\n\n- `sortOrder?: 'asc' | 'desc'`\n\n- `startingAfter?: string`\n\n- `tags?: string[]`\n\n- `workflowIDs?: string[]`\n\n- `workflowNames?: string[]`\n\n### Returns\n\n- `{ id: string; createdAt: string; edges: { destinationNodeName: string; sourceNodeName: string; destinationName?: string; }[]; mainNodeName: string; name: string; nodes: { function: object; name: string; }[]; updatedAt: string; versionNum: number; audit?: { versionCreatedBy?: object; workflowCreatedBy?: object; workflowLastUpdatedBy?: object; }; displayName?: string; emailAddress?: string; tags?: string[]; }`\n  V3 read representation of a workflow version.\n\n  - `id: string`\n  - `createdAt: string`\n  - `edges: { destinationNodeName: string; sourceNodeName: string; destinationName?: string; }[]`\n  - `mainNodeName: string`\n  - `name: string`\n  - `nodes: { function: { id?: string; name?: string; versionNum?: number; }; name: string; }[]`\n  - `updatedAt: string`\n  - `versionNum: number`\n  - `audit?: { versionCreatedBy?: { createdAt: string; userActionID: string; apiKeyName?: string; emailAddress?: string; userEmail?: string; userID?: string; }; workflowCreatedBy?: { createdAt: string; userActionID: string; apiKeyName?: string; emailAddress?: string; userEmail?: string; userID?: string; }; workflowLastUpdatedBy?: { createdAt: string; userActionID: string; apiKeyName?: string; emailAddress?: string; userEmail?: string; userID?: string; }; }`\n  - `displayName?: string`\n  - `emailAddress?: string`\n  - `tags?: string[]`\n\n### Example\n\n```typescript\nimport Bem from 'bem-ai-sdk';\n\nconst client = new Bem();\n\n// Automatically fetches more pages as needed.\nfor await (const workflowListResponse of client.workflows.list()) {\n  console.log(workflowListResponse);\n}\n```",
    perLanguage: {
      csharp: {
      ...
      typescript: {
        method: 'client.workflows.list',
        example:
          "import Bem from 'bem-ai-sdk';\n\nconst client = new Bem({\n  apiKey: process.env['BEM_API_KEY'], // This is the default and can be omitted\n});\n\n// Automatically fetches more pages as needed.\nfor await (const workflowListResponse of client.workflows.list()) {\n  console.log(workflowListResponse.id);\n}",
      },
    },
  },
  {
    ...
    response:
      '{ error?: string; workflow?: { id: string; createdAt: string; edges: { destinationNodeName: string; sourceNodeName: string; destinationName?: string; }[]; mainNodeName: string; name: string; nodes: { function: function_version_identifier; name: string; }[]; updatedAt: string; versionNum: number; audit?: { versionCreatedBy?: user_action_summary; workflowCreatedBy?: user_action_summary; workflowLastUpdatedBy?: user_action_summary; }; displayName?: string; emailAddress?: string; tags?: string[]; }; }',
    markdown:
      "## create\n\n`client.workflows.create(mainNodeName: string, name: string, nodes: { function: object; name?: string; }[], displayName?: string, edges?: { destinationNodeName: string; sourceNodeName: string; destinationName?: string; }[], tags?: string[]): { error?: string; workflow?: object; }`\n\n**post** `/v3/workflows`\n\nCreate a Workflow\n\n### Parameters\n\n- `mainNodeName: string`\n  Name of the entry-point node. Must not be a destination of any edge.\n\n- `name: string`\n  Unique name for the workflow. Must match `^[a-zA-Z0-9_-]{1,128}$`.\n\n- `nodes: { function: { id?: string; name?: string; versionNum?: number; }; name?: string; }[]`\n  Call-site nodes in the DAG. At least one is required.\n\n- `displayName?: string`\n  Human-readable display name.\n\n- `edges?: { destinationNodeName: string; sourceNodeName: string; destinationName?: string; }[]`\n  Directed edges between nodes. Omit or leave empty for single-node workflows.\n\n- `tags?: string[]`\n  Tags to categorize and organize the workflow.\n\n### Returns\n\n- `{ error?: string; workflow?: { id: string; createdAt: string; edges: { destinationNodeName: string; sourceNodeName: string; destinationName?: string; }[]; mainNodeName: string; name: string; nodes: { function: function_version_identifier; name: string; }[]; updatedAt: string; versionNum: number; audit?: { versionCreatedBy?: user_action_summary; workflowCreatedBy?: user_action_summary; workflowLastUpdatedBy?: user_action_summary; }; displayName?: string; emailAddress?: string; tags?: string[]; }; }`\n\n  - `error?: string`\n  - `workflow?: { id: string; createdAt: string; edges: { destinationNodeName: string; sourceNodeName: string; destinationName?: string; }[]; mainNodeName: string; name: string; nodes: { function: { id?: string; name?: string; versionNum?: number; }; name: string; }[]; updatedAt: string; versionNum: number; audit?: { versionCreatedBy?: { createdAt: string; userActionID: string; apiKeyName?: string; emailAddress?: string; userEmail?: string; userID?: string; }; workflowCreatedBy?: { createdAt: string; userActionID: string; apiKeyName?: string; emailAddress?: string; userEmail?: string; userID?: string; }; workflowLastUpdatedBy?: { createdAt: string; userActionID: string; apiKeyName?: string; emailAddress?: string; userEmail?: string; userID?: string; }; }; displayName?: string; emailAddress?: string; tags?: string[]; }`\n\n### Example\n\n```typescript\nimport Bem from 'bem-ai-sdk';\n\nconst client = new Bem();\n\nconst workflow = await client.workflows.create({\n  mainNodeName: 'mainNodeName',\n  name: 'name',\n  nodes: [{ function: {} }],\n});\n\nconsole.log(workflow);\n```",
    perLanguage: {
      csharp: {
  ...
  },
  {
    ...
    response:
      '{ id: string; createdAt: string; edges: { destinationNodeName: string; sourceNodeName: string; destinationName?: string; }[]; mainNodeName: string; name: string; nodes: { function: object; name: string; }[]; updatedAt: string; versionNum: number; audit?: { versionCreatedBy?: object; workflowCreatedBy?: object; workflowLastUpdatedBy?: object; }; displayName?: string; emailAddress?: string; tags?: string[]; }',
    markdown:
      "## list\n\n`client.workflows.versions.list(workflowName: string, endingBefore?: number, limit?: number, sortOrder?: 'asc' | 'desc', startingAfter?: number): { id: string; createdAt: string; edges: object[]; mainNodeName: string; name: string; nodes: object[]; updatedAt: string; versionNum: number; audit?: object; displayName?: string; emailAddress?: string; tags?: string[]; }`\n\n**get** `/v3/workflows/{workflowName}/versions`\n\nList Workflow Versions\n\n### Parameters\n\n- `workflowName: string`\n\n- `endingBefore?: number`\n\n- `limit?: number`\n\n- `sortOrder?: 'asc' | 'desc'`\n\n- `startingAfter?: number`\n\n### Returns\n\n- `{ id: string; createdAt: string; edges: { destinationNodeName: string; sourceNodeName: string; destinationName?: string; }[]; mainNodeName: string; name: string; nodes: { function: object; name: string; }[]; updatedAt: string; versionNum: number; audit?: { versionCreatedBy?: object; workflowCreatedBy?: object; workflowLastUpdatedBy?: object; }; displayName?: string; emailAddress?: string; tags?: string[]; }`\n  V3 read representation of a workflow version.\n\n  - `id: string`\n  - `createdAt: string`\n  - `edges: { destinationNodeName: string; sourceNodeName: string; destinationName?: string; }[]`\n  - `mainNodeName: string`\n  - `name: string`\n  - `nodes: { function: { id?: string; name?: string; versionNum?: number; }; name: string; }[]`\n  - `updatedAt: string`\n  - `versionNum: number`\n  - `audit?: { versionCreatedBy?: { createdAt: string; userActionID: string; apiKeyName?: string; emailAddress?: string; userEmail?: string; userID?: string; }; workflowCreatedBy?: { createdAt: string; userActionID: string; apiKeyName?: string; emailAddress?: string; userEmail?: string; userID?: string; }; workflowLastUpdatedBy?: { createdAt: string; userActionID: string; apiKeyName?: string; emailAddress?: string; userEmail?: string; userID?: string; }; }`\n  - `displayName?: string`\n  - `emailAddress?: string`\n  - `tags?: string[]`\n\n### Example\n\n```typescript\nimport Bem from 'bem-ai-sdk';\n\nconst client = new Bem();\n\n// Automatically fetches more pages as needed.\nfor await (const versionListResponse of client.workflows.versions.list('workflowName')) {\n  console.log(versionListResponse);\n}\n```",
    perLanguage: {
      csharp: {
