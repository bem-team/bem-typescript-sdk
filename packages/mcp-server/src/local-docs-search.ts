...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    response:
      '{ id: string; mainFunction: { id?: string; name?: string; versionNum?: number; }; name: string; versionNum: number; audit?: { versionCreatedBy?: object; workflowCreatedBy?: object; workflowLastUpdatedBy?: object; }; createdAt?: string; displayName?: string; emailAddress?: string; relationships?: { destinationFunction: object; sourceFunction: object; destinationName?: string; }[]; tags?: string[]; updatedAt?: string; }',
    markdown:
      "## list\n\n`client.workflows.list(displayName?: string, endingBefore?: string, functionIDs?: string[], functionNames?: string[], limit?: number, sortOrder?: 'asc' | 'desc', startingAfter?: string, tags?: string[], workflowIDs?: string[], workflowNames?: string[]): { id: string; mainFunction: function_version_identifier; name: string; versionNum: number; audit?: object; createdAt?: string; displayName?: string; emailAddress?: string; relationships?: object[]; tags?: string[]; updatedAt?: string; }`\n\n**get** `/v3/workflows`\n\nList Workflows\n\n### Parameters\n\n- `displayName?: string`\n\n- `endingBefore?: string`\n\n- `functionIDs?: string[]`\n\n- `functionNames?: string[]`\n\n- `limit?: number`\n\n- `sortOrder?: 'asc' | 'desc'`\n\n- `startingAfter?: string`\n\n- `tags?: string[]`\n\n- `workflowIDs?: string[]`\n\n- `workflowNames?: string[]`\n\n### Returns\n\n- `{ id: string; mainFunction: { id?: string; name?: string; versionNum?: number; }; name: string; versionNum: number; audit?: { versionCreatedBy?: object; workflowCreatedBy?: object; workflowLastUpdatedBy?: object; }; createdAt?: string; displayName?: string; emailAddress?: string; relationships?: { destinationFunction: object; sourceFunction: object; destinationName?: string; }[]; tags?: string[]; updatedAt?: string; }`\n\n  - `id: string`\n  - `mainFunction: { id?: string; name?: string; versionNum?: number; }`\n  - `name: string`\n  - `versionNum: number`\n  - `audit?: { versionCreatedBy?: { createdAt: string; userActionID: string; apiKeyName?: string; emailAddress?: string; userEmail?: string; userID?: string; }; workflowCreatedBy?: { createdAt: string; userActionID: string; apiKeyName?: string; emailAddress?: string; userEmail?: string; userID?: string; }; workflowLastUpdatedBy?: { createdAt: string; userActionID: string; apiKeyName?: string; emailAddress?: string; userEmail?: string; userID?: string; }; }`\n  - `createdAt?: string`\n  - `displayName?: string`\n  - `emailAddress?: string`\n  - `relationships?: { destinationFunction: { id?: string; name?: string; versionNum?: number; }; sourceFunction: { id?: string; name?: string; versionNum?: number; }; destinationName?: string; }[]`\n  - `tags?: string[]`\n  - `updatedAt?: string`\n\n### Example\n\n```typescript\nimport Bem from 'bem-ai-sdk';\n\nconst client = new Bem();\n\n// Automatically fetches more pages as needed.\nfor await (const workflow of client.workflows.list()) {\n  console.log(workflow);\n}\n```",
    perLanguage: {
      csharp: {
  ...
  },
  {
    ...
    response:
      '{ error?: string; workflow?: { id: string; mainFunction: function_version_identifier; name: string; versionNum: number; audit?: object; createdAt?: string; displayName?: string; emailAddress?: string; relationships?: object[]; tags?: string[]; updatedAt?: string; }; }',
    markdown:
      "## update\n\n`client.workflows.update(workflowName: string, displayName?: string, mainFunction?: { id?: string; name?: string; versionNum?: number; }, name?: string, relationships?: { destinationFunction: function_version_identifier; sourceFunction: function_version_identifier; destinationName?: string; }[], tags?: string[]): { error?: string; workflow?: workflow; }`\n\n**patch** `/v3/workflows/{workflowName}`\n\nUpdate a Workflow\n\n### Parameters\n\n- `workflowName: string`\n\n- `displayName?: string`\n  Display name of workflow.\n\n- `mainFunction?: { id?: string; name?: string; versionNum?: number; }`\n  Main function for the workflow. The `mainFunction` and `relationships` fields act as a unit and must be provided together, or neither provided.\n\n- If `mainFunction` is provided without `relationships`, relationships will default to an empty array.\n- If `relationships` is provided, `mainFunction` must also be provided (validation error if missing).\n- If neither is provided, both mainFunction and relationships remain unchanged from the current workflow version.\n  - `id?: string`\n    Unique identifier of function. Provide either id or name, not both.\n  - `name?: string`\n    Name of function. Must be UNIQUE on a per-environment basis. Provide either id or name, not both.\n  - `versionNum?: number`\n    Version number of function.\n\n- `name?: string`\n  Name of workflow. Can be updated to rename the workflow. Must be unique within the environment and match the pattern ^[a-zA-Z0-9_-]{1,128}$.\n\n- `relationships?: { destinationFunction: { id?: string; name?: string; versionNum?: number; }; sourceFunction: { id?: string; name?: string; versionNum?: number; }; destinationName?: string; }[]`\n  Relationships between functions in the workflow. The `mainFunction` and `relationships` fields act as a unit and must be provided together, or neither provided.\n\n- If `relationships` is provided, `mainFunction` must also be provided (validation error if missing).\n- If `mainFunction` is provided without `relationships`, relationships will default to an empty array.\n- If neither is provided, both mainFunction and relationships remain unchanged from the current workflow version.\n\n- `tags?: string[]`\n  Array of tags to categorize and organize workflows.\n\n### Returns\n\n- `{ error?: string; workflow?: { id: string; mainFunction: function_version_identifier; name: string; versionNum: number; audit?: object; createdAt?: string; displayName?: string; emailAddress?: string; relationships?: object[]; tags?: string[]; updatedAt?: string; }; }`\n\n  - `error?: string`\n  - `workflow?: { id: string; mainFunction: { id?: string; name?: string; versionNum?: number; }; name: string; versionNum: number; audit?: { versionCreatedBy?: object; workflowCreatedBy?: object; workflowLastUpdatedBy?: object; }; createdAt?: string; displayName?: string; emailAddress?: string; relationships?: { destinationFunction: object; sourceFunction: object; destinationName?: string; }[]; tags?: string[]; updatedAt?: string; }`\n\n### Example\n\n```typescript\nimport Bem from 'bem-ai-sdk';\n\nconst client = new Bem();\n\nconst workflow = await client.workflows.update('workflowName');\n\nconsole.log(workflow);\n```",
    perLanguage: {
      csharp: {
  ...
  },
  {
    ...
    response:
      '{ id: string; mainFunction: { id?: string; name?: string; versionNum?: number; }; name: string; versionNum: number; audit?: { versionCreatedBy?: object; workflowCreatedBy?: object; workflowLastUpdatedBy?: object; }; createdAt?: string; displayName?: string; emailAddress?: string; relationships?: { destinationFunction: object; sourceFunction: object; destinationName?: string; }[]; tags?: string[]; updatedAt?: string; }',
    markdown:
      "## list\n\n`client.workflows.versions.list(workflowName: string, endingBefore?: number, limit?: number, sortOrder?: 'asc' | 'desc', startingAfter?: number): { id: string; mainFunction: function_version_identifier; name: string; versionNum: number; audit?: object; createdAt?: string; displayName?: string; emailAddress?: string; relationships?: object[]; tags?: string[]; updatedAt?: string; }`\n\n**get** `/v3/workflows/{workflowName}/versions`\n\nList Workflow Versions\n\n### Parameters\n\n- `workflowName: string`\n\n- `endingBefore?: number`\n\n- `limit?: number`\n\n- `sortOrder?: 'asc' | 'desc'`\n\n- `startingAfter?: number`\n\n### Returns\n\n- `{ id: string; mainFunction: { id?: string; name?: string; versionNum?: number; }; name: string; versionNum: number; audit?: { versionCreatedBy?: object; workflowCreatedBy?: object; workflowLastUpdatedBy?: object; }; createdAt?: string; displayName?: string; emailAddress?: string; relationships?: { destinationFunction: object; sourceFunction: object; destinationName?: string; }[]; tags?: string[]; updatedAt?: string; }`\n\n  - `id: string`\n  - `mainFunction: { id?: string; name?: string; versionNum?: number; }`\n  - `name: string`\n  - `versionNum: number`\n  - `audit?: { versionCreatedBy?: { createdAt: string; userActionID: string; apiKeyName?: string; emailAddress?: string; userEmail?: string; userID?: string; }; workflowCreatedBy?: { createdAt: string; userActionID: string; apiKeyName?: string; emailAddress?: string; userEmail?: string; userID?: string; }; workflowLastUpdatedBy?: { createdAt: string; userActionID: string; apiKeyName?: string; emailAddress?: string; userEmail?: string; userID?: string; }; }`\n  - `createdAt?: string`\n  - `displayName?: string`\n  - `emailAddress?: string`\n  - `relationships?: { destinationFunction: { id?: string; name?: string; versionNum?: number; }; sourceFunction: { id?: string; name?: string; versionNum?: number; }; destinationName?: string; }[]`\n  - `tags?: string[]`\n  - `updatedAt?: string`\n\n### Example\n\n```typescript\nimport Bem from 'bem-ai-sdk';\n\nconst client = new Bem();\n\n// Automatically fetches more pages as needed.\nfor await (const workflow of client.workflows.versions.list('workflowName')) {\n  console.log(workflow);\n}\n```",
    perLanguage: {
      csharp: {
