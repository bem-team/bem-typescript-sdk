  ...
  },
  {
    ...
    perLanguage: {
      ...
      csharp: {
        ...
        example:
          'ReviewerAssignParams parameters = new()\n{\n    TypeID = "typeID",\n    UserID = "usr_2xyz...",\n};\n\nvar reviewer = await client.EntityTypes.Reviewers.Assign(parameters);\n\nConsole.WriteLine(reviewer);',
      },
      http: {
        example:
