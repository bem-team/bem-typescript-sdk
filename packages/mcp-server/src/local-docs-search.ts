...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    endpoint: '/v3/fs',
    httpMethod: 'post',
    summary: 'Filesystem-style nav over parsed documents and entity memory',
    description:
