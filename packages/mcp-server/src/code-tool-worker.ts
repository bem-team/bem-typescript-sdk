...
import { Bem, ClientOptions } from 'bem-ai-sdk';
...
function getTSDiagnostics(code: string): string[] {
  ...
  const codeWithImport = [
    ...
    functionSource.type === 'declaration' ?
      `async function run(${functionSource.client}: Bem)`
    : `const run: (${functionSource.client}: Bem) => Promise<unknown> =`,
    functionSource.code,
  ].join('\n');
...
const fuse = new Fuse(
  [
    ...
    'client.errors.list',
    'client.errors.retrieve',
    'client.outputs.list',
    'client.outputs.retrieve',
    'client.workflows.call',
    ...
    'client.eval.score.cancel',
    'client.eval.score.create',
    'client.eval.score.retrieve',
    'client.fs.navigate',
    ...
    'client.entities.bulkCreate',
    'client.entities.bulkValidate',
    'client.entities.retrieveRelations',
    'client.entities.retrieveSeedStatus',
    'client.entities.update',
    'client.entities.synonyms.add',
