...
[![NPM version](<https://img.shields.io/npm/v/bem.svg?label=npm%20(stable)>)](https://npmjs.org/package/bem) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/bem)
...
```sh
npm install git+ssh://git@github.com:stainless-sdks/bem-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npm install bem`
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/bem-typescript/issues) with questions, bugs, or suggestions.
